...
BEGIN
    ...
    INTO v_existing 
    FROM JISREM.CLEANUP 
    WHERE cleanup_name='20260925_111228_Cleanup_05_Current_Inmates_StatusChanges_With_NoHumanAction_3';
    
    IF v_existing>0 THEN 
         RAISE_APPLICATION_ERROR(-20002,'Cleanup [20260925_111228_Cleanup_05_Current_Inmates_StatusChanges_With_NoHumanAction_3] already exists'); 
    END IF;
    
    
    INSERT INTO JISREM.CLEANUP(cleanup_id,cleanup_name,description,requested_by,status)
    VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5','20260925_111228_Cleanup_05_Current_Inmates_StatusChanges_With_NoHumanAction_3','Target current Inmates with changes to status, location, or bond amount that have no human activity in the audit trail after the first status, location, or bond amt change in the go live period.','JIS','CREATED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF1867A1', '1248550', '73420', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF1953A1', '1249703', '281830', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF1973A1', '1249830', '233866', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF501A1', '1239666', '256234', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF601A1', '1240415', '244656', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF65A1', '1236986', '220365', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF912A5', '1242853', '281377', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026MM460A1', '1240500', '207281', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026MM809A1', '1244233', '244656', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2009MM4112A1', '717372', '105906', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2012MM5547A1', '846927', '220657', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2014CF1634A9', '931230', '98344', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2015CF754A1', '941373', '182345', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2016CF161A2', '974491', '236300', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2016CF161A3', '974490', '236300', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2016CF161A5', '974493', '236300', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2016CF3155A2', '998566', '247369', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2018CF1071A1', '1046793', '192519', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2018CF2654A2', '1058599', '34745', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2018CF403A2', '1041540', '244579', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2019MM441A1', '1073677', '258701', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2020CF1960A1', '1109222', '105906', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2021CF732A1', '1127529', '264614', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2022CF1599A13', '1158536', '232816', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2022CF1599A4', '1158028', '232816', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2022CF162A2', '1147614', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2022CF1982A4', '1157425', '260690', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2022CF2039A1', '1157716', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2022CF3607A2', '1167706', '233068', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF1135A5', '1175788', '272689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF189B12', '1176122', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF189B17', '1176207', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF189B22', '1176212', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF189B3', '1176109', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF189B32', '1224285', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF189E16', '1176249', '272689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF196A15', '1169870', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF196A17', '1169872', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF196A4', '1169859', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF196A5', '1169860', '269073', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF2547A5', '1185941', '273890', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF275A2', '1170410', '271076', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF2912A2', '1187957', '274192', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF513A1', '1171821', '271076', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF513A2', '1171822', '271076', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF518A5', '1171840', '271076', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CF719A4', '1172832', '269739', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023CT1752A1', '1186466', '257737', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2023MM2401A1', '1190770', '105578', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF1372A1', '1200671', '275648', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF1764B1', '1204003', '225002', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF1764B4', '1204015', '225002', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF1764C1', '1204006', '235826', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF1775A4', '1203018', '235826', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF2331A2', '1206434', '240234', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF2662A1', '1208409', '258884', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF2958A4', '1210245', '263824', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF2958B4', '1211099', '277234', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF3244A3', '1212932', '198564', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF3439A5', '1213538', '277589', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024CF3439A6', '1213539', '277589', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024HH855A1', '1208451', '161309', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024MM2495A1', '1214318', '270585', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2024MM388A1', '1195447', '180800', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF1797A1', '1225966', '195187', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2026A4', '1227292', '277689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2026A5', '1227293', '277689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2027A2', '1227298', '277689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2027A4', '1227300', '277689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2054A2', '1227435', '78646', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF246A4', '1216071', '274757', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF246A7', '1216074', '274757', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2627A3', '1231056', '279687', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2830A2', '1232344', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2830A6', '1232348', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2830A8', '1232350', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF283A2', '1216738', '278033', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2917A4', '1232878', '241974', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2917A6', '1232880', '241974', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2934B13', '1233400', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2934B3', '1233391', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2934B6', '1233394', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2934B7', '1233395', '245731', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2939A2', '1233033', '252306', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2939A3', '1233034', '252306', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2946A2', '1233094', '280168', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2974A32', '1240897', '280192', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF2974A33', '1240898', '280192', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF3193A4', '1234657', '252306', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF599A3', '1218090', '155506', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF664A1', '1218439', '278302', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CF676A3', '1218504', '267704', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025CT165A3', '1216238', '168108', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025HH1057A1', '1233439', '127827', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025HH106A1', '1216764', '278080', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025HH1165A4', '1235126', '280023', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2025MM1843A2', '1231959', '207281', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF1183A4', '1244371', '145279', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF14A1', '1236685', '243836', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('f59ba806-0313-4ea0-85bd-89e3b68057a5', '2026CF1672A1', '1247131', '248979', 'QUEUED');

JISREM.LOG
(
    p_cleanup_id => 'f59ba806-0313-4ea0-85bd-89e3b68057a5',
    p_step_name  => 'INITIALIZATION',
    p_message    => 'Cleanup [20260925_111228_Cleanup_05_Current_Inmates_StatusChanges_With_NoHumanAction_3] started'
);
...
(
   ...
   UPDATE
    ...
    WHERE
        cleanup_id = 'f59ba806-0313-4ea0-85bd-89e3b68057a5'
...
END IF;
       ...
       WHERE cleanup_id = 'f59ba806-0313-4ea0-85bd-89e3b68057a5'
       AND charge_id = '1248550';
...
SELECT
    source_row.*,
    'f59ba806-0313-4ea0-85bd-89e3b68057a5',
    'UPDATE',
    'BEFORE'
...
AND CHARGE_ID = 1248550
AND cleanup_id = 'f59ba806-0313-4ea0-85bd-89e3b68057a5';
...
IF v_docket_id_str IS NOT NULL THEN
    ...
    VALUES (v_inserted_id, '1248550', SYSDATE,SYSDATE, 'APPF',
           ...
           ' JIS RECORD CORRECTION, BATCH ' || 'f59ba806-0313-4ea0-85bd-89e3b68057a5' );
