...
BEGIN
    ...
    INTO v_existing 
    FROM JISREM.CLEANUP 
    WHERE cleanup_name='20260925_093047_Cleanup_03_DocketsWithoutStatusChanges_17';
    
    IF v_existing>0 THEN 
         RAISE_APPLICATION_ERROR(-20002,'Cleanup [20260925_093047_Cleanup_03_DocketsWithoutStatusChanges_17] already exists'); 
    END IF;
    
    
    INSERT INTO JISREM.CLEANUP(cleanup_id,cleanup_name,description,requested_by,status)
    VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc','20260925_093047_Cleanup_03_DocketsWithoutStatusChanges_17','Removes docket entries that do not have status, location, or bond amount changes','JIS','CREATED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH169A3', '1239836', '171120', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF547A3', '1240058', '207133', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF612A2', '1240497', '277973', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF613A1', '1240501', '214880', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH209A1', '1240613', '240980', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH211A1', '1240625', '265347', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2025CF2974A13', '1240888', '280192', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF704A3', '1241058', '180807', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF721A2', '1241124', '215924', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF721A1', '1241127', '215924', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM532A1', '1241159', '221899', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF838A3', '1241842', '281316', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF840A1', '1242124', '148137', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM598A1', '1242248', '273385', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF868A1', '1242623', '281312', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM626A1', '1242749', '273385', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF913A1', '1242855', '261823', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF955A2', '1243065', '270122', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF973A1', '1243202', '280612', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF978A4', '1243255', '269574', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1042A4', '1243578', '278606', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1042A5', '1243579', '278606', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1069A2', '1243711', '281327', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1119A1', '1243997', '281541', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1123A3', '1244031', '281388', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1124A4', '1244047', '281545', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH363A1', '1244052', '271108', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM786A1', '1244084', '171037', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM843A1', '1244595', '273385', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM851A2', '1244672', '146128', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH411A5', '1244748', '238689', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1261A3', '1244798', '197007', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1264A3', '1244813', '280575', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1275A1', '1244869', '262818', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH438A2', '1245094', '273833', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1319A11', '1245114', '269574', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1319A13', '1245116', '269574', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1319A19', '1245122', '269574', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1324A1', '1245160', '276577', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH450A1', '1245295', '268695', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1373A1', '1245414', '281310', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM986A2', '1245652', '11163', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1418A3', '1245681', '281768', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1418A2', '1245682', '281768', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1445A2', '1245806', '269574', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1517A1', '1246244', '281783', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1535A3', '1246328', '279154', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH540A1', '1246390', '280635', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1566A2', '1246498', '281836', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1566A3', '1246499', '281836', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1566A8', '1246504', '281836', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1566A10', '1246506', '281836', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH558A1', '1246888', '262297', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1627A1', '1246894', '281903', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CT793A1', '1246954', '46065', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM1150A1', '1247043', '281924', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1671A1', '1247128', '276338', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1683A2', '1247274', '281938', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM1166A1', '1247303', '281713', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2025CF2448A3', '1247466', '27008', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1788A1', '1247802', '244926', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1794A1', '1247842', '281121', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1796A2', '1247860', '282005', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1799A2', '1247867', '239145', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A3', '1248158', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A6', '1248161', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A35', '1248190', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A36', '1248191', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A46', '1248201', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A58', '1248213', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1815A80', '1248235', '274162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1828A1', '1248282', '269525', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1840A1', '1248354', '282064', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1849A3', '1248467', '260305', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH618A2', '1248476', '114542', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1852A2', '1248485', '123286', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1870A1', '1248563', '233374', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1870A4', '1248566', '233374', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1894A1', '1248742', '282102', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM1317A1', '1248752', '250068', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH647A1', '1249128', '282118', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1931A1', '1249523', '274411', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026HH664A5', '1249538', '264490', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1942A2', '1249580', '282162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1942A3', '1249581', '282162', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026MM1380A1', '1249662', '281061', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1952A1', '1249693', '197351', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1964A1', '1249771', '183719', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1965A1', '1249788', '131167', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF1818A1', '1250808', '282043', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc', '2026CF2228A1', '1251731', '35925', 'QUEUED');

JISREM.LOG
(
    p_cleanup_id => '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc',
    p_step_name  => 'INITIALIZATION',
    p_message    => 'Cleanup [20260925_093047_Cleanup_03_DocketsWithoutStatusChanges_17] started'
);
...
(
    p_cleanup_id => '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc',
    p_step_name  => 'INITIALIZATION',
    p_message    => '[91] case(s) will be affected'
);
...
BEGIN
       ...
       WHERE cleanup_id = '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc'
...
SELECT
    source_row.*,
    '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc',
    'DELETE',
    'BEFORE'
...
AND CHARGE_ID = 1239836
AND cleanup_id = '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc';
...
IF v_docket_id_str IS NOT NULL THEN
    ...
    VALUES (v_inserted_id, '1239836', SYSDATE,SYSDATE, 'APPF',
           ...
           ' JIS RECORD CORRECTION, BATCH ' || '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc' );
...
(
    ...
    p_message    => 'Completed cleanup for case'
        ...
        SET
            status = 'PROCESSED'
        WHERE
            cleanup_id = '06a3d3bf-01b5-4fb7-bbdf-71954be9ccbc'
            AND charge_id = '1239836';
