...
BEGIN
    ...
    INTO v_existing 
    FROM JISREM.CLEANUP 
    WHERE cleanup_name='20260925_104726_Cleanup_01_GroceryStoreRun_4';
    
    IF v_existing>0 THEN 
         RAISE_APPLICATION_ERROR(-20002,'Cleanup [20260925_104726_Cleanup_01_GroceryStoreRun_4] already exists'); 
    END IF;
    
    
    INSERT INTO JISREM.CLEANUP(cleanup_id,cleanup_name,description,requested_by,status)
    VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7','20260925_104726_Cleanup_01_GroceryStoreRun_4','Grocery store run; Initial cleanup of cases with only invalid system activity for defendants already released.','JIS','CREATED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026HH524A1', '1246299', '150898', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026HH244A1', '1241367', '150898', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2020MM644A1', '1102969', '150898', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2016CF1152A1', '984150', '150898', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2015CF2136A1', '952737', '150898', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026CF1389A3', '1245493', '158208', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026CF1389A2', '1245494', '158208', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026CF1389A1', '1245492', '158208', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026CF376A3', '1239000', '196085', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026CF376A2', '1239001', '196085', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2026CF376A1', '1239002', '196085', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2020CF1126A2', '1104726', '257857', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('02b6e094-2a2b-43fd-a173-7815a3eabda7', '2020CF1126A1', '1104725', '257857', 'QUEUED');

JISREM.LOG
(
    p_cleanup_id => '02b6e094-2a2b-43fd-a173-7815a3eabda7',
    p_step_name  => 'INITIALIZATION',
    p_message    => 'Cleanup [20260925_104726_Cleanup_01_GroceryStoreRun_4] started'
);
...
(
    p_cleanup_id => '02b6e094-2a2b-43fd-a173-7815a3eabda7',
    p_step_name  => 'INITIALIZATION',
    p_message    => '[13] case(s) will be affected'
);
...
(
   ...
   UPDATE
    ...
    WHERE
        cleanup_id = '02b6e094-2a2b-43fd-a173-7815a3eabda7'
...
END IF;
       ...
       WHERE cleanup_id = '02b6e094-2a2b-43fd-a173-7815a3eabda7'
       AND charge_id = '1246299';
...
SELECT
    source_row.*,
    '02b6e094-2a2b-43fd-a173-7815a3eabda7',
    'UPDATE',
    'BEFORE'
...
WHERE EXISTS (
    ...
    AND d.cleanup_id = '02b6e094-2a2b-43fd-a173-7815a3eabda7'
)
AND source_row.CREATE_DATE_TIME >= to_date('2026-08-18','YYYY-MM-DD')
AND NVL(UPPER(TRIM(source_row.create_user_id)),'~') IN ('JISJDW','PNX2JIS','SYSTEMA')
;
...
AND CHARGE_ID = 1246299
AND cleanup_id = '02b6e094-2a2b-43fd-a173-7815a3eabda7';
...
IF v_docket_id_str IS NOT NULL THEN
    ...
    VALUES (v_inserted_id, '1246299', SYSDATE,SYSDATE, 'APPF',
           ...
           ' JIS RECORD CORRECTION, BATCH ' || '02b6e094-2a2b-43fd-a173-7815a3eabda7' );
