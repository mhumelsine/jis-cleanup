...
BEGIN
    ...
    INTO v_existing 
    FROM JISREM.CLEANUP 
    WHERE cleanup_name='Judical Order 2024CF1550';
    
    IF v_existing>0 THEN 
         RAISE_APPLICATION_ERROR(-20002,'Cleanup [Judical Order 2024CF1550] already exists'); 
    END IF;
    
    
    INSERT INTO JISREM.CLEANUP(cleanup_id,cleanup_name,description,requested_by,status)
    VALUES('375377db-33b8-4e39-80a5-24c6ab47b44d','Judical Order 2024CF1550','Manual correction for single case','Jessica Gillespie','CREATED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('375377db-33b8-4e39-80a5-24c6ab47b44d', '2024CF1550A2', '1201630', '276036', 'QUEUED');

JISREM.LOG
(
    p_cleanup_id => '375377db-33b8-4e39-80a5-24c6ab47b44d',
    p_step_name  => 'INITIALIZATION',
    p_message    => 'Cleanup [Judical Order 2024CF1550] started'
);
...
(
    p_cleanup_id => '375377db-33b8-4e39-80a5-24c6ab47b44d',
    p_step_name  => 'INITIALIZATION',
    p_message    => '[1] case(s) will be affected'
);
...
SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
/***********************************************************
***** CHARGE 1201630 CJIS_CASE_NUMBER 2024CF1550A2
***********************************************************/
...
BEGIN
   SAVEPOINT before_record;
       ...
       WHERE cleanup_id = '375377db-33b8-4e39-80a5-24c6ab47b44d'
       AND charge_id = '1201630';
...
SELECT
    source_row.*,
    '375377db-33b8-4e39-80a5-24c6ab47b44d',
    'UPDATE',
    'BEFORE'
FROM JISJDW.CHARGE source_row
WHERE CHARGE_ID = '1201630'
;
...
and source_row.CHARGE_ID = 1201630
...
(
    ...
    p_message    => 'Completed cleanup for case'
        ...
        SET
            status = 'PROCESSED'
        WHERE
            cleanup_id = '375377db-33b8-4e39-80a5-24c6ab47b44d'
            AND charge_id = '1201630';
