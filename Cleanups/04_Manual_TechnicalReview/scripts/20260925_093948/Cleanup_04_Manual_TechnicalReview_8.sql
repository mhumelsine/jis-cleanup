...
BEGIN
    ...
    INTO v_existing 
    FROM JISREM.CLEANUP 
    WHERE cleanup_name='20260925_093948_Cleanup_04_Manual_TechnicalReview_8';
    
    IF v_existing>0 THEN 
         RAISE_APPLICATION_ERROR(-20002,'Cleanup [20260925_093948_Cleanup_04_Manual_TechnicalReview_8] already exists'); 
    END IF;
    
    
    INSERT INTO JISREM.CLEANUP(cleanup_id,cleanup_name,description,requested_by,status)
    VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2','20260925_093948_Cleanup_04_Manual_TechnicalReview_8','Deep technical review of cases with human activity since 8/18.','JIS','CREATED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CT668A1', '1245383', '281734', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CT668A2', '1245384', '281734', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM956A1', '1245490', '281746', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1416A1', '1245668', '281773', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM992A1', '1245735', '281781', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1009A1', '1245910', '281799', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1494A1', '1246106', '281813', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1498A1', '1246132', '281814', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1498A2', '1246133', '281814', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1498A3', '1246134', '281814', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1500A1', '1246136', '281816', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1500A2', '1246137', '281816', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CT1009A1', '1250188', '281825', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1072A1', '1246482', '281859', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1261A1', '1248279', '281885', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1123A1', '1246896', '281904', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1657A1', '1247038', '281923', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1657A2', '1247039', '281923', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1657A3', '1247040', '281923', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1168A1', '1247311', '281944', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1716A1', '1247443', '281967', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1716A2', '1247441', '281967', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1716A3', '1247442', '281967', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1736A1', '1247536', '281970', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1736A2', '1247538', '281970', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1736A3', '1247537', '281970', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CT840A1', '1247573', '281982', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CT914A1', '1248687', '281992', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CT914A2', '1248688', '281992', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1219A1', '1247720', '282006', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1426A1', '1249930', '282021', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1897A1', '1248757', '282104', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1897A2', '1248758', '282104', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1897A3', '1248759', '282104', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1897A4', '1248760', '282104', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1897A5', '1248761', '282104', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1325A1', '1249025', '282115', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1325A2', '1249026', '282115', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1325A3', '1249027', '282115', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026HH656A1', '1249489', '282146', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026HH656A2', '1249490', '282146', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1360A1', '1249510', '282149', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1932A1', '1249531', '282155', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1943A1', '1249620', '282165', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1945A1', '1249629', '282168', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1385A1', '1249677', '282172', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1389A1', '1249687', '282174', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1389A2', '1249688', '282174', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1954A1', '1249716', '282177', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1954A2', '1249717', '282177', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF1954A3', '1249718', '282177', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1431A1', '1249948', '282202', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1438A1', '1250084', '282211', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1440A1', '1250108', '282213', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1441A1', '1250153', '282217', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1447A1', '1250290', '282233', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026MM1458A1', '1250349', '282238', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2034A1', '1250357', '282244', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2034A2', '1250356', '282244', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2038A1', '1250371', '282248', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A1', '1251257', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A10', '1251266', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A11', '1251267', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A12', '1251268', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A13', '1251269', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A14', '1251270', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A15', '1251271', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A16', '1251272', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A17', '1251273', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A18', '1251274', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A19', '1251275', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A2', '1251258', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A20', '1251276', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A21', '1251277', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A22', '1251278', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A23', '1251279', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A24', '1251280', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A25', '1251281', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A26', '1251282', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A27', '1251283', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A28', '1251284', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A29', '1251285', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A3', '1251259', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A30', '1251286', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A31', '1251287', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A32', '1251288', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A33', '1251289', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A34', '1251290', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A35', '1251291', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A36', '1251292', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A37', '1251293', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A38', '1251294', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A39', '1251295', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A4', '1251260', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A40', '1251296', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A41', '1251297', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A42', '1251298', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A43', '1251299', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A44', '1251300', '282273', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('1bfa4ab0-1665-44da-97d9-0587e26494d2', '2026CF2159A45', '1251301', '282273', 'QUEUED');

JISREM.LOG
(
    p_cleanup_id => '1bfa4ab0-1665-44da-97d9-0587e26494d2',
    p_step_name  => 'INITIALIZATION',
    p_message    => 'Cleanup [20260925_093948_Cleanup_04_Manual_TechnicalReview_8] started'
);
...
(
   ...
   UPDATE
    ...
    WHERE
        cleanup_id = '1bfa4ab0-1665-44da-97d9-0587e26494d2'
...
END IF;
       ...
       WHERE cleanup_id = '1bfa4ab0-1665-44da-97d9-0587e26494d2'
       AND charge_id = '1245383';
...
SELECT
    source_row.*,
    '1bfa4ab0-1665-44da-97d9-0587e26494d2',
    'DELETE',
    'BEFORE'
...
AND CHARGE_ID = 1245383
AND cleanup_id = '1bfa4ab0-1665-44da-97d9-0587e26494d2';
...
IF v_docket_id_str IS NOT NULL THEN
    ...
    VALUES (v_inserted_id, '1245383', SYSDATE,SYSDATE, 'APPF',
           ...
           ' JIS RECORD CORRECTION, BATCH ' || '1bfa4ab0-1665-44da-97d9-0587e26494d2' );
