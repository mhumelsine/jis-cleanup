...
BEGIN
    ...
    INTO v_existing 
    FROM JISREM.CLEANUP 
    WHERE cleanup_name='Cleanup_03_DocketsWithoutStatusChange_Partition_11';
    
    IF v_existing>0 THEN 
         RAISE_APPLICATION_ERROR(-20002,'Cleanup [Cleanup_03_DocketsWithoutStatusChange_Partition_11] already exists'); 
    END IF;
    
    
    INSERT INTO JISREM.CLEANUP(cleanup_id,cleanup_name,description,requested_by,status)
    VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d','Cleanup_03_DocketsWithoutStatusChange_Partition_11','Removes docket entries that do not status changes','JIS','CREATED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF948A2', '1243031', '255598', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF948A3', '1243032', '255598', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF948A4', '1243033', '255598', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF948A5', '1243035', '255598', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF948A6', '1243034', '255598', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2378A1', '1229516', '255696', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2378A2', '1229517', '255696', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2378A4', '1230578', '255696', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM1534A1', '1251036', '256245', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM1369A1', '1249564', '256508', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024MM1886A1', '1209151', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024MM1886A2', '1209152', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF1508A1', '1224115', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025MM2161A1', '1234651', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025MM2161A2', '1234652', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025MM52A1', '1215160', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025MM52A2', '1215161', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM103A1', '1237887', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM382A1', '1239827', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM424A1', '1240213', '256697', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2909A1', '1232829', '257246', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF621A1', '1240551', '257246', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF621A2', '1240552', '257246', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF621A3', '1240553', '257246', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF621A4', '1240554', '257246', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024MM1157A1', '1202058', '257257', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH138A1', '1239313', '257260', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH605A1', '1248060', '257302', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH605A2', '1248061', '257302', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH605A3', '1248062', '257302', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF1255A1', '1222728', '257463', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF1255A2', '1222726', '257463', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF940A1', '1220404', '257463', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1832A1', '1248297', '257463', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1832A2', '1248295', '257463', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH504A1', '1245942', '257506', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF1706A4', '1230003', '257737', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2241A1', '1228593', '257737', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2241A2', '1228594', '257737', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2241A3', '1228595', '257737', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1599A2', '1246743', '258245', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1599A3', '1246744', '258245', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM1074A1', '1246511', '258348', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF3136A1', '1234292', '258889', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025MM2062A1', '1233987', '258889', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF103A1', '1147346', '259222', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2062A1', '1205054', '259222', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2062A2', '1205063', '259222', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2792A1', '1209278', '259222', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A1', '1237028', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A2', '1237029', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A3', '1237030', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A4', '1237031', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A5', '1237032', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A6', '1237033', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH23A7', '1237034', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM629A1', '1242763', '259456', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2023CF372A1', '1170987', '260219', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2023CF372A2', '1170988', '260219', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF1432A1', '1223696', '260305', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1849A1', '1248465', '260305', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1849A2', '1248466', '260305', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1849A3', '1248467', '260305', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2019CF2223A2', '1083602', '260384', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2021CF1340A1', '1131655', '260607', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF1841A1', '1156679', '260690', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF1956A1', '1226930', '260795', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026MM1366A1', '1249548', '260907', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2019CF3657A1', '1092004', '260934', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF3121A1', '1164149', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF3121A2', '1164150', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2023CF359A1', '1170912', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2023CF359A2', '1170911', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2023CF359A3', '1170913', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2023CF359A4', '1170914', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2025CF2204A1', '1228392', '260977', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF2314A1', '1159329', '261226', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF2314A2', '1159330', '261226', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2022CF2314A3', '1159332', '261226', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH554A1', '1246815', '261281', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF836A1', '1241837', '261627', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF1928A1', '1203759', '261795', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF1928A2', '1203757', '261795', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF1928A3', '1203758', '261795', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2015B1', '1205858', '261795', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF913A1', '1242855', '261823', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF913A2', '1242856', '261823', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF913A3', '1242857', '261823', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1617A1', '1246825', '262297', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1617A3', '1246826', '262297', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026HH558A1', '1246888', '262297', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2019CF4221A1', '1095793', '262373', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2020CF532A1', '1100678', '262373', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2026CF1704A1', '1247404', '262373', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2643B1', '1210432', '262479', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2643B2', '1210433', '262479', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2913A1', '1209991', '262515', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2913A2', '1209992', '262515', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF2913A3', '1209993', '262515', 'QUEUED');

INSERT INTO JISREM.CLEANUP_CASE_QUEUE(cleanup_id, case_id, charge_id, spn_id, status) 
VALUES('eecc040d-0277-4fb5-94a9-a0bb86a2f21d', '2024CF3309A1', '1212661', '262515', 'QUEUED');

JISREM.LOG
(
    p_cleanup_id => 'eecc040d-0277-4fb5-94a9-a0bb86a2f21d',
    p_step_name  => 'INITIALIZATION',
    p_message    => 'Cleanup [Cleanup_03_DocketsWithoutStatusChange_Partition_11] started'
);
...
BEGIN
   SAVEPOINT before_record;
       ...
       WHERE cleanup_id = 'eecc040d-0277-4fb5-94a9-a0bb86a2f21d'
...
SELECT
    source_row.*,
    'eecc040d-0277-4fb5-94a9-a0bb86a2f21d',
    'DELETE',
    'BEFORE'
...
AND CHARGE_ID = 1243031
AND cleanup_id = 'eecc040d-0277-4fb5-94a9-a0bb86a2f21d';
...
IF v_docket_id_str IS NOT NULL THEN
    ...
    VALUES (v_inserted_id, '1243031', SYSDATE,SYSDATE, 'APPF',
           ...
           ' JIS RECORD CORRECTION, BATCH ' || 'eecc040d-0277-4fb5-94a9-a0bb86a2f21d' );
...
(
    ...
    p_message    => 'Completed cleanup for case'
        ...
        SET
            status = 'PROCESSED'
        WHERE
            cleanup_id = 'eecc040d-0277-4fb5-94a9-a0bb86a2f21d'
            AND charge_id = '1243031';
...
/***********************************************************
***** CHARGE 1248295 CJIS_CASE_NUMBER 2026CF1832A2
***********************************************************/
...
and source_row.CHARGE_ID = 1248295
AND source_row.CREATE_DATE_TIME >= to_date('2026-08-18','YYYY-MM-DD')
AND NVL(UPPER(TRIM(source_row.create_user_id)),'~') IN ('JISJDW','PNX2JIS','SYSTEMA')
;
...
IF v_docket_id_str IS NOT NULL THEN
    ...
    INSERT INTO JISJDW.cjis_docket (cjis_docket_id, charge_id, docket_date, received_date, docket_code, docket_free_text)
    VALUES (v_inserted_id, '1248295', SYSDATE,SYSDATE, 'APPF',
           'PURSUANT TO ADMINISTRATIVE ORDER 2026-__ ENTERED 09/__/2026, REMOVED ERRONEOUS SYSTEM-GENERATED '||
           'DOCKET ENTRIES SEQ [' || v_docket_id_str || '] ' ||
           'CREATED 08/18-08/21/2026 DURING THE COUNTY''S UPGRADE TO THE LEGACY JIS SYSTEM.'||
           ' [CASE STATUS RESTORED TO STATUS AS OF 08/17/2026.] NO OTHER DOCKET ENTRY ALTERED.'||
...
and source_row.CHARGE_ID = 1170987
AND source_row.CREATE_DATE_TIME >= to_date('2026-08-18','YYYY-MM-DD')
AND NVL(UPPER(TRIM(source_row.create_user_id)),'~') IN ('JISJDW','PNX2JIS','SYSTEMA')
;
...
and source_row.CHARGE_ID = 1170988
AND source_row.CREATE_DATE_TIME >= to_date('2026-08-18','YYYY-MM-DD')
AND NVL(UPPER(TRIM(source_row.create_user_id)),'~') IN ('JISJDW','PNX2JIS','SYSTEMA')
;
